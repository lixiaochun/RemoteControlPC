...
import com.malikbilal.remotecontrolpc.reciever.CallbackReceiver;
...
public abstract class TransferFileToServer extends AsyncTask<String, String, Void> implements CallbackReceiver {
    ...
    protected TransferFileToServer(Context context) {
    ...
    protected void onPreExecute() {
        ...
        progressDialog.setTitle("Transferring File");
        ...
        try {
            if (MainActivity.clientSocket != null) {
                if (MainActivity.objectOutputStream == null) {
                    ...
                    MainActivity.objectOutputStream = new ObjectOutputStream(MainActivity.clientSocket.getOutputStream());
