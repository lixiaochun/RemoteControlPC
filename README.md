...
1. *Browse your Android Phone files on your Computer.*
2. *Touchpad -> Movements, Left Click, Right Click.*
3. *Keyboard -> Qucik Text, Useful Keyboard Shortcuts.*
4. *File Transfer -> Transfer Android files to Computer.*
5. *File Download -> Download Computer files to Android.*
6. *Media Player -> Play your mp3 files on Computer.*
7. *Image Viewer -> View Gallery Images on Computer.*
8. *Screen Share -> Live Computer Screen on Android.*
9. *Power Options -> Lock, Suspend, Shutdown, Restart.*
